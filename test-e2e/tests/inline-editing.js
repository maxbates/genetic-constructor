...
module.exports = {
  'Test that you can inline edit block name, construct names and project names' : function (browser) {
    ...
    // project title
    browser
      .click('.ProjectHeader-title')
      .waitForElementPresent('input.inline-editor', 5000, 'expected inline editor to appear for project title')
      .clearValue('input.inline-editor')
      .setValue('input.inline-editor', ['Bernie Saunders', browser.Keys.ENTER])
      .pause(1000)
      .assert.containsText( 'div', 'Bernie Saunders', 'expected project name to update')
      .end();
  }
};
