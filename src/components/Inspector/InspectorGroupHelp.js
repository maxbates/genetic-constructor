...
class InspectorGroupHelp extends Component {
  ...
  render() {
    return (<div className="InspectorGroupHelp">
      ...
      <a target="_blank" href="https://geneticconstructor.readme.io/docs/how-to-contribute">Contributing to Genetic Constructor</a>
      ...
      <a onClick={this.onBugOrFeedback} href="#">Report a Bug</a>
      <a onClick={this.onBugOrFeedback} href="#">Give us Feedback</a>
      <br/>
      <div className="Section">Information</div>
      <a target="_blank" href="http://bionano.autodesk.com/GeneticDesign/index.html">About Genetic Constructor</a>
      <a target="_blank" href="http://www.autodesk.com/company/legal-notices-trademarks/terms-of-service-autodesk360-web-services">Terms of Use</a>
      <a target="_blank" href="http://www.autodesk.com/company/legal-notices-trademarks/privacy-statement">Privacy Policy</a>
