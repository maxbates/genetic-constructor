      ...
      <ModalWindow
        ...
        payload={(
          ...
          >
            ...
            <p>Genetic Constructor automatically saves every edit you make, but the most recent edit could not be saved,
              and will be rolled back.</p>
            <p>Please reload the page to revert your project, and try the action again.</p>
            <p>If you repeatedly encounter this problem, please <a
              href="https://forum.bionano.autodesk.com/c/genetic-constructor/support"
              target="_blank"
