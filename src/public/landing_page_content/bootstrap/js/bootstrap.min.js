...
if (typeof jQuery === 'undefined') throw new Error("Bootstrap's JavaScript requires jQuery"); +(function (a) {
  ...
  function b(b) {
    ...
    d = function (b) { a(b).on('click', c, this.close); }; d.VERSION = '3.3.7', d.TRANSITION_DURATION = 150, d.prototype.close = function (b) {
       function c() { g.detach().trigger('closed.bs.alert').remove(); } let e = a(this),
        f = e.attr('data-target'); f || (f = e.attr('href'), f = f && f.replace(/.*(?=#[^\s]*$)/, '')); let g = a(f === '#' ? [] : f); b && b.preventDefault(), g.length || (g = e.closest('.alert')), g.trigger(b = a.Event('close.bs.alert')), b.isDefaultPrevented() || (g.removeClass('in'), a.support.transition && g.hasClass('fade') ? g.one('bsTransitionEnd', c).emulateTransitionEnd(d.TRANSITION_DURATION) : c());
  ...
  } let c = function (b, d) { this.$element = a(b), this.options = a.extend({}, c.DEFAULTS, d), this.isLoading = !1; }; c.VERSION = '3.3.7', c.DEFAULTS = { loadingText: 'loading...' }, c.prototype.setState = function (b) {
     let c = 'disabled',
      d = this.$element,
  ...
  function b(b) {
    ...
    function d() { e.hoverState != 'in' && f.detach(), e.$element && e.$element.removeAttr('aria-describedby').trigger(`hidden.bs.${e.type}`), b && b(); } let e = this,
    f = a(this.$tip),
  ...
  function b(b) {
  ...
  } let c = function (b) { this.element = a(b); }; c.VERSION = '3.3.7', c.TRANSITION_DURATION = 150, c.prototype.show = function () {
    let b = this.element,
    ...
    function f() { g.removeClass('active').find('> .dropdown-menu > .active').removeClass('active').end().find('[data-toggle="tab"]').attr('aria-expanded', !1), b.addClass('active').find('[data-toggle="tab"]').attr('aria-expanded', !0), h ? (b[0].offsetWidth, b.addClass('in')) : b.removeClass('fade'), b.parent('.dropdown-menu').length && b.closest('li.dropdown').addClass('active').end().find('[data-toggle="tab"]').attr('aria-expanded', !0), e && e(); } let g = d.find('> .active'),
  ...
  } let c = function (b, d) { this.options = a.extend({}, c.DEFAULTS, d), this.$target = a(this.options.target).on('scroll.bs.affix.data-api', a.proxy(this.checkPosition, this)).on('click.bs.affix.data-api', a.proxy(this.checkPositionWithEventLoop, this)), this.$element = a(b), this.affixed = null, this.unpin = null, this.pinnedOffset = null, this.checkPosition(); }; c.VERSION = '3.3.7', c.RESET = 'affix affix-top affix-bottom', c.DEFAULTS = { offset: 0, target: window }, c.prototype.getState = function (a, b, c, d) {
